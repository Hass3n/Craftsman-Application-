...
public class CraftsmanAdapter extends RecyclerView.Adapter<CraftsmanAdapter.Holder> {

    private Context context;
    private ArrayList<Datacrafstman> showData;





    public CraftsmanAdapter(Context context, ArrayList<Datacrafstman> showData) {
    ...
    public void onBindViewHolder(@NonNull Holder holder,final int i) {
        ...
        final Datacrafstman currentShowData = showData.get(i);  // i = position
